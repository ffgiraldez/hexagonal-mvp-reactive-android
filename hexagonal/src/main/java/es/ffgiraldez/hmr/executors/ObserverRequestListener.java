 ...
 */
public class ObserverRequestListener<T> implements RequestListener<T> {
    // ----------------------------------
    // CONSTANTS
    // ----------------------------------
    private static final String TAG = ObserverRequestListener.class.getSimpleName();
    ...
    // LIFE CYCLE
    // ----------------------------------
    public ObserverRequestListener(Observer<T> subject) {
